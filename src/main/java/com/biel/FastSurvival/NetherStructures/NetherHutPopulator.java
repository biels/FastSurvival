...
//        Bukkit.broadcastMessage(number + " D: " + number*100/(double)attempts);
    ...
    void generateChest(Location center) {
        ...
        if (Utils.Possibilitat(10)) it.add(new ItemStack(Material.GOLDEN_SWORD));
        ...
        if (Utils.Possibilitat(10)) it.add(new ItemStack(Material.GOLDEN_SHOVEL));
        ...
        if (Utils.Possibilitat(6)) it.add(new ItemStack(Material.GOLDEN_PICKAXE));
        ...
        if (Utils.Possibilitat(2)) it.add(new ItemStack(Material.EXPERIENCE_BOTTLE, 3));
